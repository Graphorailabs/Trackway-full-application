...
// import { SchematicRoutingProvider } from "@/features/schematic/editor/context/RoutingContext";

import { SchematicLayout } from "@/features/schEditor/SchematicLayout";
...
export default function SchematicPage() {
    // Ensure the schematic page provides a full-height flex container so
    // the camera viewport and canvases receive a non-zero layout size.
    return (
        <div className="h-screen flex flex-col bg-white">
            <SchematicLayout />
        </div>
