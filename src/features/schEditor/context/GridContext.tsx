...
// Light gray canvas theme (minor/major grid lines use subtle dark gray)
const defaultBackground = "#f3f4f6"; // light gray (Tailwind gray-100)
const defaultMinor = "rgba(0, 0, 0, 0.06)";
const defaultMajor = "rgba(0, 0, 0, 0.12)";
